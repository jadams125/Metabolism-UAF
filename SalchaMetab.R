...
#convert to meters
library(pracma)
feet <-  pracma::nthroot(discharge$X_00060_00000,3)
meters <- feet*0.3048
meters3 <- I(meters^3)
discharge$X_00060_00000.meters <- meters3
...
Salcha.exo.2021$DateTime <- as.POSIXct(Salcha.exo.2021$datetimeAK)
...
Salcha_DoD_and_USGS_2021$solar.time.salcha <- as.POSIXct(Salcha_DoD_and_USGS_2021$DateTime, tz= 'America/Anchorage')
...
Salcha_DoD_and_USGS_2021$LightSalcha <- as.numeric(calc_light(Salcha_DoD_and_USGS_2021$UTC.test, 64, 146))
...
Salcha_DoD_and_USGS_2021 <- Salcha_DoD_and_USGS_2021 %>%
  dplyr::rename(discharge = X_00060_00000)

Salcha_DoD_and_USGS_2021 <- Salcha_DoD_and_USGS_2021 %>%
  dplyr::rename(DO.sat = ModelDOSat)

Salcha_DoD_and_USGS_2021 <- Salcha_DoD_and_USGS_2021 %>%
  dplyr::rename(solar.time = UTC.test)
...
mm.test <- metab(specs = bayes_specs, data=data.salcha.mm)
